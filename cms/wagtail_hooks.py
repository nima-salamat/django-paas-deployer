"""
Register domain models in Wagtail admin (snippets / model viewsets).

Keeps the existing Django models editable inside Wagtail without rewriting them.
"""
...
def _register():
    ...
    class UserViewSet(SnippetViewSet):
        ...
        # Avoid exposing password hash in the form UI
        form_fields = None  # default; panels can be refined later
