...
urlpatterns = (
    ...
    + [
        ...
        path("service/<uuid:service_id>/networks/", ServiceNetworksAPIView.as_view(), name="service_networks"),
        path("service/<uuid:service_id>/databases/", ServiceDatabaseBindingsAPIView.as_view(), name="service_database_bindings"),
        path("service/<uuid:service_id>/database-resources/", DatabaseResourceAPIView.as_view(), name="service_database_resources"),
        ...
        path("services/<uuid:service_id>/shell/audit/export/", shell_audit_export_apiview, name="service_shell_audit_export"),
