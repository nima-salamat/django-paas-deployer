...
class DocumentAssetAPIView(APIView):
    ...
    def get(self, request, asset_id):
        try:
            ...
            raise Http404
        # Unattached assets are private library objects. Only assets referenced
        # by a published document may be served publicly. Draft assets require
        # docs.manage, preventing accidental asset enumeration/leakage.
