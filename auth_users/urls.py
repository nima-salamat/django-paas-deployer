...
from .apis import LoginAPIView, ValidateAPIView, AuthAPIView, SigninView, SigninOrLoginAPIView
...
urlpatterns = [
    ...
    path("api/authentication/", SigninOrLoginAPIView.as_view(), name="signin_or_login"),
]
